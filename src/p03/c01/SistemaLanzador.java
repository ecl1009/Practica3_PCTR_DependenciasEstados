...
/**
 * Clase SistemaLanzador - Lanza los Thread correspondientes a cada proceso de entrada/salida de cada puerta del parque.
 * 
...
public class SistemaLanzador {
	...
	/**
	 * Método principal main - Lanza 10 Threads, 5 de entrada y 5 de salida del parque.
	 * 
	 * Cada Thread de entrada o salida corresponde a una puerta del parque, teniendo en total 5 puertas, cada una con su
	 * proceso o actividad de entrada y salida.
	 * 
