...
/**
 * Clase Parque - Implementa un parque en el que se tiene un aforo máximo dado
 * por AFOROMAX y un aforo mínimo dado por AFOROMIN.
 * 
 * Se controlan las entradas y salidas del parque por cada una de las puertas y
 * se obtiene el tiempo medio de estancia. Cada puerta de entrada y salida se
 * simula de forma concurrente con varios hilos. Cada hilo se corresponde con
 * una puerta de entrada o salida.
 * 
...
public class Parque implements IParque {
	...
	/**
	 * Método sincronizado entrarAlParque - Simula una entrada por una puerta del
	 * parque.
	 * 
	 * Se comprueban las precondiciones antes de entrar al parque, se actualizan los
	 * valores y se notifica a todos los hilos.
	 * 
	 * @param puerta String con el nombre de la puerta por la que se entra al
	 *               parque.
	 */
	@Override
	...
	/**
	 * Método sincronizado salirDelParque - Simula una salida por una puerta del
	 * parque.
	 * 
	 * Se comprueban las precondiciones antes de salir del parque, se actualizan los
	 * valores y se notifica a todos los hilos.
	 * 
	 * @param puerta String con el nombre de la puerta por la que se sale del
	 *               parque.
	 */
	...
	/**
	 * Método getPersonasActuales() - Obtiene el número de personas actuales en el
	 * parque.
	 * 
	 ...
	 * 
	 * Se disminuye la cantidad de personas actuales y se incrementa el total de
	 * salidas del parque.
	 * 
	 * @param puerta String con el nombre de la puerta por la que se sale del
	 *               parque.
	 ...
	 * 
	 * Se incrementa la cantidad de personas actuales y el total de entradas al
	 * parque.
	 * 
	 * @param puerta String con el nombre de la puerta por la que se entra al
	 *               parque.
	...
	/**
	 * Método inicializaEntradas - Inicializa los contadores de salida y/o entrada a
	 * 0 si estos valen null.
	 * 
	...
	/**
	 * Método inicializaSalidas - Inicializa los contadores de entrada y/o salida a
	 * 0 si estos valen null.
	 * 
	 ...
	 * 
	 * Imprime el estado del parque en el momento actual. Se muestra la información
	 * del número total de personas en el parque, el total de entradas, el total de
	 * salidas y el tiempo medio de estancia en el parque. Imprime en formato tabla
	 * la información de las entradas, salidas y el balance total de entradas y
	 * salidas por cada puerta del parque.
	 * 
	 * 
	...
	private void imprimirInfo(String puerta, String movimiento) {
		...
		System.out.println("--> Total entradas: " + totalEntradas + "\t total salidas: " + totalSalidas
				+ " \tTiempo medio de estancia: " + tmedio);
		System.out.println("");
		System.out.println("----> Puerta\tTotal entradas\tTotal salidas\tBalance");

		// Iteramos por todas las puertas e imprimimos sus entradas
		for (String p : contadoresPersonasPuerta.keySet()) {
			System.out.println("---->   " + p + "\t\t" + entradasPuertas.get(p) + "\t\t" + salidasPuertas.get(p)
					+ "\t   " + contadoresPersonasPuerta.get(p));
		}
		System.out.println(" ");
	}

	/**
	 * Método sumaContadoresPuerta - Suma todos los contadores parciales de cada
	 * puerta.
	 * 
	 * Suma los valores del balance total de entradas y salidas para cada puerta. EL
	 * resultado debe coincidir con el número total de personas en el parque.
	 * 
	...
	private int sumarContadoresPuerta() {
		...
		Enumeration<Integer> iterPuertas = contadoresPersonasPuerta.elements(); // Obtiene una enumeración con todos los
																				// contadores parciales de cada puerta

		// Mientras queden elementos en la enumeración sin sumar se repite el bloque
		// while
	...
	/**
	 * Método comprobarAntesDeEntrar - Mantiene al hilo en espera mientras la
	 * condición de entrada no se cumpla.
	 */
	...
	/**
	 * Método comprobarAntesDeSalir - Mantiene al hilo en espera mientras la
	 * condición de salida no se cumpla.
	 * 
	 */
	 ...
	 * 
	 * Si la cantidad de personas en el parque actualmente es menor que el aforo
	 * máximo se cumple la condición de entrada y retornara True, de lo contrario
	 * retornará False.
	 * 
	 ...
	 * 
	 * Si la cantidad de personas en el parque actualmente es mayor que el aforo
	 * mínimo se cumple la condición de salida y retornara True, de lo contrario
	 * retornará False.
	 * 
	 * @return True si la condición se cumple y False si no se cumple.
	 */
