 ...
 * 
 * Clase que implementa la actividad de salida de un parque. La clase será
 * creada por un objeto Thread y simula las salidas del parque. Simula una
 * puerta de salida del parque y realiza varias salidas desde esa puerta.
 * 
...
public class ActividadSalidaPuerta implements Runnable {
	 ...
	 *
	 * Inicializa los atributos puerta y parque con los parámetros pasados al
	 * constructor.
	 * 
	...
	/**
	 * Método run - Método que ejecuta el hilo al ser creado. Simula NUMSALIDAS
	 * salidas del parque.
	 */
	@Override
	public void run() {
		// Se ejecuta el bucle hasta alcanzar el número máximo de salidas establecido en
		// NUMSALIDAS
