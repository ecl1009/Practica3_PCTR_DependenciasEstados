 ...
 * 
 * Clase que implementa la actividad de entrada a un parque.
 * La clase será creada por un objeto Thread y simula las entradas al parque.
 * Simula una puerta de entrada al parque y realiza varias entradas desde esa puerta. 
 * 
...
public class ActividadEntradaPuerta implements Runnable {
	 ...
	 * 
	 * @param puerta String con el nombre de la puerta por la que se simulan las entradas.
